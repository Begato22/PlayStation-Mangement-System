...
class AccountPage extends StatelessWidget {
                  ...
                  child: SizedBox(
                    ...
                    child: ListView.separated(
                        ...
                        return outerIndex == 0
                            ...
                            : SizedBox(
                                ...
                                height: 160 *
                                    cubit
                                        .datedSession[
                                            cubit.historyDates[outerIndex - 1]]!
                                        .length
                                        .toDouble(),
                                child: ListView.builder(
                                  physics: const NeverScrollableScrollPhysics(),
                                  itemBuilder: (context, index) {
                                    return buildHistoryCard(cubit, index,
                                        cubit.historyDates[outerIndex - 1]);
                                  },
                                  itemCount: cubit
                                      .datedSession[
                      ...
                      separatorBuilder: (context, index) => Padding(
                        ...
                        child: customDividorText(cubit.historyDates[index]),
                      ),
  ...
  Card buildHistoryCard(PlaystationHomeCubit cubit, int index, String date) {
    String startTime = DateFormat.jm()
        .format(DateTime.parse(cubit.datedSession[date]![index].startTime));
    String endTime = DateFormat.jm()
        .format(DateTime.parse(cubit.datedSession[date]![index].endTime));
    return Card(
      child: Container(
        padding: const EdgeInsets.all(20),
                        ...
                        child: Container(
                          ...
                          child: Row(
                            children: [
                              ...
                              Text(
                                "${cubit.datedSession[date]![index].sessionType} - ${cubit.getSpesificRoom(cubit.datedSession[date]![index].roomId).deviceType}",
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Text(
                                cubit
                                    .getSpesificRoom(
                                        cubit.datedSession[date]![index].roomId)
                                    .name,
                                style: const TextStyle(
                                  fontSize: 15,
                                  fontWeight: FontWeight.bold,
            ...
            Row(
              children: [
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    rowData('Date: ', cubit.datedSession[date]![index].date,
                        Icons.date_range, Colors.black),
                    const SizedBox(height: 3),
                    rowData(
                        'Start Time: ', startTime, Icons.watch, Colors.black),
                    const SizedBox(height: 3),
                ...
                PhysicalShape(
                  ...
                  child: CircleAvatar(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(
                            '${cubit.datedSession[date]![index].totalCost.ceil()}'),
                        const Text(
                          ' EG',
  ...
  Widget rowData(
      String title, String data, IconData iconData, Color iconColor) {
    return Row(
      children: [
        Icon(
          iconData,
