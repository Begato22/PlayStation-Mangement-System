                            ...
                            children: [
                              Row(
                                children: [
                                  Text(
                                    cubit
                                        .getSpesificRoom(cubit.online[index].id)
                                        .name,
                                  ...
                                  buildTimer(
                                    ...
                                    context,
                                    cubit.online[index],
                                    cubit.getDateTimeOfSpesificSession(
                                      cubit
                                          .getSpesificRoom(
                                              cubit.online[index].roomId)
                                          .id,
                                    ),
                                  ),
                                ],
                              ...
                              Row(
                                children: [
                                  Column(
                                    ...
                                    children: [
                                      rowData('Start Time:', startTime,
                                          Icons.watch, Colors.black),
                                      const SizedBox(height: 5),
                                      rowData(
                                          'Total Time: ',
                                          cubit.online[index].isOpenTime
                                              ? 'Waiting'
                                              : '${cubit.online[index].duration.ceil()} min',
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      rowData(
                                          ...
                                          cubit.online[index].isOpenTime
                                              ? 'Waiting'
                                              : '${cubit.online[index].totalCost.ceil()} EG',
