// enum LastState { onBoardering, login, homeLayout }

// String lastScreen = 'onBoardering';
...
void endingTime({
  ...
  await cubit.updateStatusRoomDatabase(
      'false', cubit.getSpesificRoom(sessionModel.roomId).id);
  await cubit.insertNewHistoryIntoDatabase(
    date: DateFormat('yMd').format(DateTime.now()),
    roomId: cubit.getSpesificRoom(sessionModel.roomId).id,
